...
public class CancelReservationController {
    ...
    public CancelReservationController(CancelReservation gui, User user) {
        this.gui = gui;
        this.user = user;
            ...
            if (id.isEmpty()) {
                ...
                if (!database.searchForBookedAccomodation(id)) {
                    ...
                    if (result) {
                        ...
                        JOptionPane.showMessageDialog(null, "You are successfully canceled your reservation !", null, JOptionPane.INFORMATION_MESSAGE);
                        RetrieveBookedAccomodations();
                    } else {
                        JOptionPane.showMessageDialog(null, "Wrong ID !", null, JOptionPane.ERROR_MESSAGE);
                    }
